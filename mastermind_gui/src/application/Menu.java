...
public class Menu extends Application{
	...
	static Stage window;
	static Scene main_scene, tutorial_scene, game_scene, settings_scene;
	static VBox main_menu, tutorial, game_menu, settings; //game;
	...
	static Button tut1, set1,set2,set3, set4, set8, set9, game_exit, game_cancel, game_again;
	static Label tut2, set5, set6, set7, set10, set11, game_timer, game_over;
